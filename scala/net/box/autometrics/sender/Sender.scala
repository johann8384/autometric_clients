...
object Sender {
  ...
  def main(args: Array[String]) {
    ...
    c.write("{\"name\":\"webapp.uploads\",\"value\":7,\"type\":\"counter\",\"timestamp\":\"1348860180\",\"tags\":{\"type\":\"start\",\"runmode\":\"api_upload_v2\"}}", new InetSocketAddress("255.255.255.255", 8080))
